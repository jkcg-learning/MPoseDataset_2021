...
misc_paths = dict(kth='scripts/misc/kth_splitter.csv',
                  ixmas='scripts/misc/ixmas_exclude.csv',
                  i3dpost='scripts/misc/i3dpost_archives.csv',
                  isld='scripts/misc/isld_truth.xlsx',
                  utkinect='scripts/misc/utkinect_splitter.txt',
                  utdmhad='scripts/misc/utdmhad_truth.csv',
                  checksum_video='scripts/misc/cksum_video.csv',
                  checksum_rgb='scripts/misc/cksum_rgb.csv',
                  checksum_pose='scripts/misc/cksum_pose.csv',
                  outliers='scripts/misc/refine_dataset')
